...
import { HOME_TREE, WP1_TREE, WP1_INFO, TEST_META_CONTENT } from '../test_cases';
...
beforeEach(async () => {
  ...
  mockServerAPI({
    ...
    '/lookup': [
      ...
      { query: { 'name': 'Home' }, response: {"name":"Home","ids":[],"children":["WP1","WP2"],"tierType":"folder"} }
...
describe('tree browser', () => {
  test('construct', async () => {
    ...
    expect(widget.render()).toEqual(<div><a>Loading</a></div>)
    ...
    expect(widget.render()).not.toEqual(<div><a>Loading</a></div>)
